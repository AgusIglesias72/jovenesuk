...
export function Button({
  ...
  const variants: Record<ButtonVariant, string> = {
    ...
    accent:
      "bg-[image:var(--grad-warm)] text-[var(--c-ink-onaccent)] shadow-[var(--shadow-accent)] hover:brightness-[1.03] focus-visible:shadow-[var(--ring-accent)]",
    outline:
...
export function SectionTitle({
  ...
  return (
    <div>
      {kicker && (
        <p className="text-[var(--t-label)] font-bold uppercase tracking-[var(--ls-label)] text-[var(--c-brand)]">
          {kicker}
        </p>
      )}
