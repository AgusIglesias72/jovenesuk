...
export const metadata = { title: "Marino · Design Lab · JUK" };
...
function ScreenHeading({
  ...
  return (
    <div className="mb-6 flex items-end gap-4">
      ...
      <div>
        <h2 className="font-[family-name:var(--font-display)] text-[var(--t-h1)] font-semibold leading-[var(--lh-tight)] tracking-[var(--ls-tight)] text-[var(--c-ink)]">
          {title}
        </h2>
...
const SWATCHES: { label: string; v: string; ink?: string }[] = [
  { label: "navy-950", v: "var(--c-brand)", ink: "var(--c-ink-onbrand)" },
  { label: "navy-700", v: "var(--c-brand-600)", ink: "var(--c-ink-onbrand)" },
  { label: "navy-500", v: "var(--c-brand-500)", ink: "var(--c-ink-onbrand)" },
  { label: "navy-100", v: "var(--c-brand-100)", ink: "var(--c-ink)" },
  { label: "gold", v: "var(--c-accent)", ink: "var(--c-ink-onaccent)" },
  { label: "gold-600", v: "var(--c-accent-600)", ink: "var(--c-ink-onbrand)" },
  { label: "coral", v: "var(--c-coral-600)", ink: "var(--c-ink-onbrand)" },
      ...
      <div className="mx-auto max-w-6xl px-4 py-7 sm:px-6 lg:px-10">
        <div className="flex flex-wrap items-baseline justify-between gap-3">
          <div className="flex items-center gap-3">
            <span className="grid h-9 w-9 place-items-center rounded-[var(--r-md)] bg-[var(--c-brand)] text-[var(--c-ink-onbrand)] shadow-[var(--shadow-brand)]">
              <span className="font-[family-name:var(--font-display)] text-lg font-bold">J</span>
            </span>
            <div>
              <p className="font-[family-name:var(--font-display)] text-[var(--t-h3)] font-semibold text-[var(--c-ink)]">
                Dirección Marino
              </p>
              <p className="text-[var(--t-small)] text-[var(--c-ink-muted)]">
                Claro · aireado · navy + oro · sobrio
              </p>
            </div>
          </div>
          <p className="font-[family-name:var(--font-mono)] text-[var(--t-small)] text-[var(--c-ink-subtle)]">
            Editá{" "}
            <span className="rounded-[var(--r-xs)] bg-[var(--c-surface-2)] px-1.5 py-0.5 text-[var(--c-brand-600)]">
              src/app/design/marino/tokens.css
            </span>{" "}
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <div>
            ...
            <p className="font-[family-name:var(--font-display)] text-3xl font-semibold leading-none tracking-[var(--ls-tight)] text-[var(--c-ink)]">
              Fraunces
            </p>
            <p className="mt-1 font-[family-name:var(--font-body)] text-[var(--t-body)] text-[var(--c-ink-muted)]">
              Inter — cuerpo claro y neutral.
            </p>
...
function StatCard({
  ...
  return (
    <Card className="relative overflow-hidden p-5">
      ...
      <p
        className="mt-2 font-[family-name:var(--font-display)] text-5xl font-semibold leading-none tracking-[var(--ls-tight)]"
        style={{ color: accent }}
      >
        {value}
      </p>
...
function TripCard({
  ...
  return (
    <Card className="group flex flex-col overflow-hidden transition-transform duration-200 hover:-translate-y-1 hover:shadow-[var(--shadow-2)]">
      {/* header sólido navy, sin degradé */}
      <div className="relative h-24 bg-[var(--c-brand)]">
        <span className="absolute left-4 top-4 font-[family-name:var(--font-mono)] text-[var(--t-small)] font-bold text-[var(--c-ink-onbrand-muted)]">
          {code}
        </span>
        <span className="absolute right-4 top-4">{badge}</span>
        <span className="absolute bottom-0 left-0 h-1 w-full bg-[var(--c-accent)]" aria-hidden />
      </div>
      <div className="flex flex-1 flex-col p-5">
        <h3 className="font-[family-name:var(--font-display)] text-[var(--t-h3)] font-semibold text-[var(--c-ink)]">
          {title}
        </h3>
        ...
        <div className="mt-4 pt-4 border-t border-[var(--c-border)]">
          ...
          <div className="mt-2 h-2.5 w-full overflow-hidden rounded-[var(--r-pill)] bg-[var(--c-surface-2)]">
            <div
              className="h-full rounded-[var(--r-pill)] bg-[var(--c-accent)]"
              style={{ width: `${pct}%` }}
            />
          </div>
        </div>
    ...
    <Screen id="dashboard">
      ...
      <div className="mb-2 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <h3 className="font-[family-name:var(--font-display)] text-[var(--t-display-2)] font-semibold leading-[var(--lh-tight)] tracking-[var(--ls-tight)] text-[var(--c-ink)]">
            Buen día, Agustín.
          </h3>
        </div>
      ...
      <div className="mt-8">
        <div className="flex items-end justify-between">
          ...
          <a
            href="#viaje"
            className="text-[var(--t-small)] font-semibold text-[var(--c-accent-600)] hover:underline"
          >
            Ver todos →
          </a>
        </div>
...
function AlumnosListCard() {
  return (
    <Card className="overflow-hidden">
      {/* header — fill plano de la card, sin degradé */}
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[var(--c-border)] p-5">
        <div>
          <h3 className="font-[family-name:var(--font-display)] text-[var(--t-h2)] font-semibold text-[var(--c-ink)]">
            Alumnos
          </h3>
      ...
      {/* tabla — FULL WIDTH (w-full, ocupa todo el contenedor) */}
            ...
            {ALUMNOS.map((a, i) => (
              ...
              >
                <td className="px-5 py-3">
                  <div className="flex items-center gap-3">
                    <span
                      className="grid h-10 w-10 shrink-0 place-items-center rounded-[var(--r-pill)] font-[family-name:var(--font-display)] text-[var(--t-small)] font-semibold text-[var(--c-brand)]"
                      style={{ backgroundColor: "var(--c-brand-100)" }}
                      aria-hidden
                    >
                      {a.nombre[0]}
...
function AlumnosScreen() {
  return (
    <Screen id="alumnos">
      ...
      />
      {/* Tabla arriba a todo el ancho; formulario debajo, también full-width */}
...
function ViajeScreen() {
  return (
    <Screen id="viaje">
      ...
      {/* header del viaje — navy SÓLIDO, sin degradé, con filete de oro */}
      <Card
        className="relative mb-6 overflow-hidden border-0 bg-[var(--c-surface-inverse)] p-6 text-[var(--c-ink-onbrand)]"
        as="section"
      >
        <span className="absolute inset-x-0 bottom-0 h-1 bg-[var(--c-accent)]" aria-hidden />
        <div className="relative flex flex-wrap items-start justify-between gap-4">
          <div>
            <span className="font-[family-name:var(--font-mono)] text-[var(--t-small)] font-bold text-[var(--c-ink-onbrand-muted)]">
              UK-2026-JUL-LONDON
            </span>
            <h3 className="mt-1 font-[family-name:var(--font-display)] text-[var(--t-display-2)] font-semibold leading-[var(--lh-tight)] tracking-[var(--ls-tight)]">
      ...
      <div className="mt-8">
        ...
        <Card className="mt-5 overflow-hidden">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[var(--c-border)] bg-[var(--c-brand-50)] p-5">
            <div className="flex items-center gap-3">
              <span className="font-[family-name:var(--font-mono)] text-[var(--t-small)] font-bold text-[var(--c-brand-600)]">
                01
              </span>
              <h4 className="font-[family-name:var(--font-display)] text-[var(--t-h3)] font-semibold text-[var(--c-ink)]">
                Pasajes
              </h4>
            </div>
  ...
  return (
    <Screen id="login">
      <ScreenHeading
        ...
        sub="La puerta de entrada: marca sobria a la izquierda, formulario directo a la derecha."
      />
      <Card className="overflow-hidden p-0">
        <div className="grid lg:grid-cols-2">
          {/* panel de marca — navy SÓLIDO, sin un solo degradé */}
          <div className="relative flex min-h-[440px] flex-col justify-between overflow-hidden bg-[var(--c-surface-inverse)] p-8 text-[var(--c-ink-onbrand)]">
            <span className="absolute inset-y-0 right-0 w-1 bg-[var(--c-accent)]" aria-hidden />

            <div className="relative flex items-center gap-3">
              <span className="grid h-12 w-12 place-items-center rounded-[var(--r-lg)] bg-[var(--c-accent)] text-[var(--c-ink-onaccent)] shadow-[var(--shadow-accent)]">
                <span className="font-[family-name:var(--font-display)] text-2xl font-semibold">J</span>
              </span>
              <div className="leading-tight">
                <p className="font-[family-name:var(--font-display)] font-semibold">Jóvenes en UK</p>
                <p className="text-[var(--t-small)] text-[var(--c-ink-onbrand-muted)]">Portal Interno</p>
              </div>
            </div>

            <div className="relative">
              <p className="font-[family-name:var(--font-display)] text-[var(--t-display-2)] font-semibold leading-[var(--lh-tight)] tracking-[var(--ls-tight)]">
          ...
          <div className="flex items-center justify-center p-8 sm:p-12">
            <div className="w-full max-w-sm">
              <h3 className="font-[family-name:var(--font-display)] text-[var(--t-h1)] font-semibold tracking-[var(--ls-tight)] text-[var(--c-ink)]">
                Ingresar al portal
              </h3>
              ...
              <p className="mt-6 text-center text-[var(--t-small)] text-[var(--c-ink-muted)]">
                ...
                <a className="font-semibold text-[var(--c-accent-600)] hover:underline" href="#login">
                  Restablecerla
                </a>
              </p>
            </div>
...
export default function MarinoPage() {
  return (
    <div
      className={`v-marino ${display.variable} ${body.variable} ${mono.variable} min-h-screen font-[family-name:var(--font-body)] text-[var(--c-ink)]`}
    ...
    >
      ...
      <footer className="border-t border-[var(--c-border)] px-6 py-8 text-center text-[var(--t-small)] text-[var(--c-ink-subtle)]">
        Dirección <span className="font-semibold text-[var(--c-ink-muted)]">Marino</span> · concept de
