...
export const metadata = { title: "Puerto · Design Lab · JUK" };
...
function ScreenHeading({
  ...
  return (
    <div className="mb-6 flex items-end gap-4">
      <span className="font-[family-name:var(--font-mono)] text-[var(--t-small)] font-semibold text-[var(--c-accent-600)]">
        {n}
      </span>
      <div>
...
const SWATCHES: { label: string; v: string; ink?: string }[] = [
  { label: "brand-950", v: "var(--c-brand-950)", ink: "var(--c-ink-onbrand)" },
  { label: "brand-900", v: "var(--c-brand-900)", ink: "var(--c-ink-onbrand)" },
  { label: "brand-700", v: "var(--c-brand-700)", ink: "var(--c-ink-onbrand)" },
  { label: "brand-500", v: "var(--c-brand-500)", ink: "var(--c-ink-onbrand)" },
  { label: "gold", v: "var(--c-accent)", ink: "var(--c-ink-onaccent)" },
  { label: "gold-500", v: "var(--c-accent-500)", ink: "var(--c-ink-onaccent)" },
  { label: "coral", v: "var(--c-berry)", ink: "var(--c-ink-onbrand)" },
      ...
      <div className="mx-auto max-w-6xl px-4 py-7 sm:px-6 lg:px-10">
        <div className="flex flex-wrap items-baseline justify-between gap-3">
          <div className="flex items-center gap-3">
            <span
              className="grid h-10 w-10 place-items-center rounded-[var(--r-md)] text-[var(--c-ink-onbrand)] shadow-[var(--shadow-brand)]"
              style={{ backgroundColor: "var(--c-brand-950)" }}
            >
              <span className="font-[family-name:var(--font-display)] text-lg font-bold">J</span>
            </span>
            <div>
              ...
              <p className="text-[var(--t-small)] text-[var(--c-ink-muted)]">
                Navy estructural · sólido · sobrio
              </p>
            </div>
          </div>
          <p className="font-[family-name:var(--font-mono)] text-[var(--t-small)] text-[var(--c-ink-subtle)]">
            ...
            <span className="rounded-[var(--r-xs)] bg-[var(--c-surface-2)] px-1.5 py-0.5 text-[var(--c-brand)]">
              src/app/design/puerto/tokens.css
            </span>{" "}
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <div>
            ...
            <p className="font-[family-name:var(--font-display)] text-3xl font-bold leading-none tracking-[var(--ls-tight)] text-[var(--c-ink)]">
              Fraunces
            </p>
            <p className="mt-1 font-[family-name:var(--font-body)] text-[var(--t-body)] text-[var(--c-ink-muted)]">
              Libre Franklin — cuerpo claro y sobrio.
            </p>
...
function SubNav() {
  return (
    <nav className="sticky top-0 z-40 border-b border-[var(--c-border)] bg-[color-mix(in_srgb,var(--c-page)_88%,transparent)] backdrop-blur">
...
function StatCard({
  ...
  return (
    <Card className="relative overflow-hidden p-5">
      ...
      <p
        className="mt-2 font-[family-name:var(--font-display)] text-5xl font-bold leading-none tracking-[var(--ls-tight)]"
        style={{ color: accent }}
      >
        {value}
      </p>
...
function TripCard({
  ...
  return (
    <Card className="group flex flex-col overflow-hidden transition-transform duration-200 hover:-translate-y-1 hover:shadow-[var(--shadow-2)]">
      {/* banda navy SÓLIDA (sin degradé) con filete oro al pie */}
      <div
        className="relative h-24 border-b-2 border-[var(--c-accent)]"
        style={{ backgroundColor: "var(--c-brand-950)" }}
      >
        <span className="absolute left-4 top-4 font-[family-name:var(--font-mono)] text-[var(--t-small)] font-semibold text-[var(--c-ink-onbrand-muted)]">
          {code}
        </span>
        ...
        <div className="mt-4 pt-4 border-t border-[var(--c-border)]">
          ...
          <div className="mt-2 h-2.5 w-full overflow-hidden rounded-[var(--r-pill)] bg-[var(--c-surface-2)]">
            <div
              ...
              style={{ width: `${pct}%`, backgroundColor: "var(--c-brand-700)" }}
            />
          </div>
        </div>
      </div>
...
function DashboardScreen() {
  return (
    <Screen id="dashboard">
      ...
      {/* Hero sobrio en navy SÓLIDO — el elemento estructural de Puerto */}
      <Card
        className="relative mb-6 overflow-hidden border-0 p-6 text-[var(--c-ink-onbrand)] sm:p-7"
        as="section"
      >
        <div className="absolute inset-0" style={{ backgroundColor: "var(--c-brand-950)" }} />
        <div className="absolute bottom-0 left-0 h-1 w-full bg-[var(--c-accent)]" aria-hidden />
        <div className="relative flex flex-wrap items-end justify-between gap-4">
          <div>
            <p className="font-[family-name:var(--font-mono)] text-[var(--t-small)] font-semibold uppercase tracking-[var(--ls-label)] text-[var(--c-accent-500)]">
              Lunes 31 de mayo
            </p>
            <h3 className="mt-1 font-[family-name:var(--font-display)] text-[var(--t-display-2)] font-bold leading-[var(--lh-tight)] tracking-[var(--ls-tight)]">
              Buen día, Agustín.
            </h3>
            <p className="mt-2 max-w-md text-[var(--t-small)] text-[var(--c-ink-onbrand-muted)]">
              Tres viajes en preparación y la inscripción de julio abierta.
            </p>
          </div>
      ...
      <div className="mt-8">
        ...
        <Card className="mt-3 flex items-center gap-4 border-[var(--c-border-brand)] bg-[var(--c-brand-50)] p-5">
          <span
            className="grid h-11 w-11 shrink-0 place-items-center rounded-[var(--r-md)] text-xl text-[var(--c-ink-onbrand)]"
            style={{ backgroundColor: "var(--c-brand-700)" }}
            aria-hidden
          >
            ✓
          </span>
      ...
      <div className="mt-8">
        ...
        <div className="mt-4 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <TripCard
            ...
            badge={
              <Badge fg="var(--c-ink-onbrand)" bg="rgba(255,255,255,0.14)" dot>
                Inscripción abierta
              </Badge>
            }
...
function AlumnosListCard() {
  return (
    <Card className="overflow-hidden">
      {/* header navy SÓLIDO con filete oro */}
      <div
        className="flex flex-wrap items-center justify-between gap-3 border-b-2 border-[var(--c-accent)] p-5 text-[var(--c-ink-onbrand)]"
        style={{ backgroundColor: "var(--c-brand-950)" }}
      >
        <div>
          <h3 className="font-[family-name:var(--font-display)] text-[var(--t-h2)] font-bold">
            Alumnos
          </h3>
          <p className="text-[var(--t-small)] text-[var(--c-ink-onbrand-muted)]">60 alumnos</p>
        </div>
      ...
      <div className="flex flex-wrap gap-3 border-b border-[var(--c-border)] bg-[var(--c-surface-3)] p-4">
        <div className="relative min-w-[220px] flex-1">
          ...
          <input
            ...
            className="min-h-[var(--tap)] w-full rounded-[var(--r-pill)] border border-[var(--c-border-strong)] bg-[var(--c-surface)] pl-11 pr-4 text-[var(--t-body)] text-[var(--c-ink)] placeholder:text-[var(--c-ink-subtle)] focus:border-[var(--c-brand-400)] focus:shadow-[var(--ring-focus)] focus:outline-none"
          />
        </div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse text-left">
          <thead>
            <tr className="border-b border-[var(--c-border)] bg-[var(--c-surface-2)] text-[var(--t-label)] uppercase tracking-[var(--ls-label)] text-[var(--c-ink-muted)]">
          ...
          <tbody>
            {ALUMNOS.map((a, i) => (
              ...
              >
                ...
                <td className="px-5 py-3 align-middle">
                  {a.vto === "—" ? (
                    <span className="text-[var(--t-small)] text-[var(--c-ink-subtle)]">—</span>
                  ) : (
                    <span className="font-[family-name:var(--font-mono)] text-[var(--t-small)] text-[var(--c-ink-muted)]">
                      {a.vto}
                    </span>
                  )}
                </td>
...
function AlumnoForm() {
  return (
    <Card className="overflow-hidden">
      {/* header navy SÓLIDO con filete oro */}
      <div
        className="border-b-2 border-[var(--c-accent)] p-5 text-[var(--c-ink-onbrand)]"
        style={{ backgroundColor: "var(--c-brand-950)" }}
      >
        <h3 className="font-[family-name:var(--font-display)] text-[var(--t-h2)] font-bold">
          Nuevo alumno
        </h3>
        <p className="text-[var(--t-small)] text-[var(--c-ink-onbrand-muted)]">
          Los campos con <span className="text-[var(--c-accent-500)]">*</span> son obligatorios.
        </p>
      </div>
...
function AlumnosScreen() {
  return (
    <Screen id="alumnos">
      ...
      />
      {/* Tabla full-width arriba, formulario abajo (la tabla manda al 100%). */}
  ...
  return (
    <div
      className={[
        ...
        active
          ? "border-[var(--c-brand-400)] bg-[var(--c-brand-50)] shadow-[var(--shadow-2)]"
          : "border-[var(--c-border)] bg-[var(--c-surface)] shadow-[var(--shadow-soft)]",
      ].join(" ")}
    >
      <div className="flex items-center justify-between">
        <span className="font-[family-name:var(--font-mono)] text-[var(--t-small)] font-semibold text-[var(--c-ink-subtle)]">
          {n}
        </span>
...
function ViajeScreen() {
  return (
    <Screen id="viaje">
      ...
      {/* header del viaje — banda navy SÓLIDA con filete oro */}
      <Card
      ...
      >
        ...
        <div className="relative flex flex-wrap items-start justify-between gap-4">
          <div>
            <span className="font-[family-name:var(--font-mono)] text-[var(--t-small)] font-semibold text-[var(--c-accent-500)]">
              UK-2026-JUL-LONDON
            </span>
            <h3 className="mt-1 font-[family-name:var(--font-display)] text-[var(--t-display-2)] font-bold leading-[var(--lh-tight)] tracking-[var(--ls-tight)]">
      ...
      <div className="mt-8">
        ...
        <Card className="mt-5 overflow-hidden">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[var(--c-border)] bg-[var(--c-brand-50)] p-5">
            <div className="flex items-center gap-3">
              <span className="font-[family-name:var(--font-mono)] text-[var(--t-small)] font-semibold text-[var(--c-brand)]">
                01
              </span>
  ...
  return (
    <Screen id="login">
      <ScreenHeading
        ...
        sub="La puerta de entrada: panel de marca en navy sólido a la izquierda, formulario directo a la derecha."
      />
      <Card className="overflow-hidden p-0">
        <div className="grid lg:grid-cols-2">
          {/* panel de marca — navy SÓLIDO (cero degradé), filete oro al borde */}
          <div
            className="relative flex min-h-[440px] flex-col justify-between overflow-hidden border-b-2 border-[var(--c-accent)] p-8 text-[var(--c-ink-onbrand)] lg:border-b-0 lg:border-r-2"
            style={{ backgroundColor: "var(--c-brand-950)" }}
          >
            <div className="relative flex items-center gap-3">
              ...
              >
                <span className="font-[family-name:var(--font-display)] text-2xl font-bold">J</span>
              </span>
            ...
            <div className="relative">
              <p className="font-[family-name:var(--font-display)] text-[var(--t-display-2)] font-bold leading-[var(--lh-tight)] tracking-[var(--ls-tight)]">
          ...
          <div className="flex items-center justify-center p-8 sm:p-12">
            <div className="w-full max-w-sm">
              <h3 className="font-[family-name:var(--font-display)] text-[var(--t-h1)] font-bold tracking-[var(--ls-tight)] text-[var(--c-ink)]">
                Ingresar al portal
              </h3>
...
export default function PuertoPage() {
  return (
    <div
      className={`v-puerto ${display.variable} ${body.variable} ${mono.variable} min-h-screen font-[family-name:var(--font-body)] text-[var(--c-ink)]`}
