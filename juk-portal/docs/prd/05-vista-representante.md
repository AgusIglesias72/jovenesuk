...
> ✅ RESUELTO (**MIN-06**, decisión 11/06/2026, derivada de MIN-13): el PRD no definía cuáles pasos son "obligatorios" a efectos de la alerta crítica "viaje en menos de 3 meses con algún paso obligatorio en Pendiente". Decisión: "obligatorio" = paso **activo con config `Requerido`** (o sin config asociada: B1, C2, D1); los pasos con config `Opcional` quedan fuera de esta alerta y del % de completitud.
...
- > ✅ RESUELTO (**CRIT-04**, decisión 11/06/2026 — ⭐ validar con equipo): el PRD interno (M7 Paso 2, US-38) decía que el representante "puede aprobar o rechazar excursiones desde su vista"; este PRD (Módulo 2 y Apéndice B), que "no puede aprobar, rechazar ni confirmar actividades — solo solicitar". Decisión: el **representante aprueba/rechaza desde su vista** (manda el Interno); las solicitudes de cambio quedan como mecanismo adicional para proponer modificaciones.
